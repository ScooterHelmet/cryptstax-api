...
func (s *server) HandleSendSMSCode(db *sql.DB) http.HandlerFunc {
...
func SendSMSCode(user User) bool {
	...
	smsMessage := "Your cryptstax verification code is: " + strconv.Itoa(smsVerificationCode)
...
func (s *server) HandleVerifySMS(db *sql.DB) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
